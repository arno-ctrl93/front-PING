...
function Azerty() {
  ...
  document.getElementById("key-M").appendChild(coma)*/
    ...
    document.onkeydown = function () {
      ...
      switch (window.event.keyCode) {
        case 65: // A key
          if (!azerty_physical) key = document.getElementById("key-A");
          else key = document.getElementById("key-Q");
          break;
        case 66: // B key
        ...
        case 76:
          ...
          break;
        case 77:
          if (!azerty_physical) key = document.getElementById("key-M");
          else key = document.getElementById("colon-M");
          break;
        case 78:
        ...
        case 80:
          ...
          break;
        case 81:
          if (!azerty_physical) key = document.getElementById("key-Q");
          else key = document.getElementById("key-A");
          break;
        case 82:
        ...
        case 86:
          ...
          break;
        case 87:
          if (!azerty_physical) key = document.getElementById("key-W");
          else key = document.getElementById("key-Z");
          break;
        case 88:
        ...
        case 89:
          ...
          break;
        case 90:
          if (!azerty_physical) key = document.getElementById("key-Z");
          else key = document.getElementById("key-W");
          break;
        // F1 to F12
        case 112:
        ...
        case 16:
          if (window.event.location === KeyboardEvent.DOM_KEY_LOCATION_LEFT) {
            ...
            window.event.location === KeyboardEvent.DOM_KEY_LOCATION_RIGHT
          ) {
  ...
  return (
    <div id="keyboard" class="keyboard-azerty">
      ...
      <div class="keyboard__row">
        ...
        <div id="key-Q" class="key--letter" data-char="Q">
          Q
        </div>
        <div id="key-W" class="key--letter" data-char="W">
          W
        </div>
        <div id="key-E" class="key--letter" data-char="E">
          E
        </div>
        <div id="key-R" class="key--letter" data-char="R">
          R
        </div>
        <div id="key-T" class="key--letter" data-char="T">
          T
        </div>
        <div id="key-Y" class="key--letter" data-char="Y">
          Y
        </div>
        <div id="key-U" class="key--letter" data-char="U">
          U
        </div>
        <div id="key-I" class="key--letter" data-char="I">
          I
        </div>
        <div id="key-O" class="key--letter" data-char="O">
          O
        </div>
        <div id="key-P" class="key--letter" data-char="P">
          P
        </div>
      ...
      <div class="keyboard__row">
        ...
        <div id="key-A" class="key--letter" data-char="A">
          A
        </div>
        <div id="key-S" class="key--letter" data-char="S">
          S
        </div>
        <div id="key-D" class="key--letter" data-char="D">
          D
        </div>
        <div id="key-F" class="key--letter" data-char="F">
          F
        </div>
        <div id="key-G" class="key--letter" data-char="G">
          G
        </div>
        <div id="key-H" class="key--letter" data-char="H">
          H
        </div>
        <div id="key-J" class="key--letter" data-char="J">
          J
        </div>
        <div id="key-K" class="key--letter" data-char="K">
          K
        </div>
        <div id="key-L" class="key--letter" data-char="L">
          L
        </div>
      ...
      <div class="keyboard__row">
        ...
        <div id="key-Z" class="key--letter" data-char="Z">
          Z
        </div>
        <div id="key-X" class="key--letter" data-char="X">
          X
        </div>
        <div id="key-C" class="key--letter" data-char="C">
          C
        </div>
        <div id="key-V" class="key--letter" data-char="V">
          V
        </div>
        <div id="key-B" class="key--letter" data-char="B">
          B
        </div>
        <div id="key-N" class="key--letter" data-char="N">
          N
        </div>
        <div id="key-M" class="key--letter" data-char="M">
          M
        </div>
...
export default function Keyboard() {
  ...
  return (
    <div class="layout">
      ...
      {(isToggled && <Azerty />) || (!isToggled && <Qwerty />)}
    </div>
  );
}
function Qwerty() {
  ...
  return (
    <div id="keyboard" class="keyboard-qwerty">
      <div class="keyboard__row keyboard__row--h1">
        <div id="key-esc" data-key="27" class="key--word">
          <span>esc</span>
        </div>
